...
// profile
const String SETTINGS_TITLE = "Ajustes";
...
const String PROFILE_NAME = "Richard Milos";
const String PROFILE_EMAIL = "richardM@gmail.com";
...
const COLOR_5 = const Color(0xFFEC9762);
const COLOR_6 = const Color(0xFF121B22);*/
const COLOR_WHI = Colors.white;
